                        ...
                        <div>
                            <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false">
                                    <header>
                                        ...
                                        <h2>Instalación del Sistema Sysecure</h2>
                                    </header>
                                    <div>
                                                        ...
                                                        <div id="bootstrap-wizard-1" class="col-sm-12">
                                                            <div class="form-bootstrapWizard">
                                                                    <ul class="bootstrapWizard form-wizard">
                                                                            <li class="active" data-target="#step1">
                                                                                    <a href="#tab1" data-toggle="tab"> <span class="step">1</span> <span class="title">Configuracíon</span> </a>
                                                                            </li>
                                                                            <li data-target="#step2">
                                                                                    <a href="#tab2" data-toggle="tab"> <span class="step">2</span> <span class="title">Base de Datos</span> </a>
                                                                            </li>
                                                            ...
                                                            <div class="tab-content">
                                                                    <div class="tab-pane active" id="tab1">
                                                                            ...
                                                                            <br>
                                                                            <h3><strong>Paso 1 </strong> - Configuración de la Base de Datos</h3>
                                                                            <p class="text-primary"> Para esto debe crear una nueva base de datos en su servidor WEB, con el nombre de <span class="label bg-color-red"> sysecure </span>, con Cotejamiento de las conexiones UTF8_general_ci </p>
                                                                            <div class="row">
                                                                                    <div class="col-sm-6">
                                                                                            <div class="form-group">
                                                                                                    <div class="input-group">
                                                                                                            <span class="input-group-addon"><i class="fa fa-cubes fa-lg fa-fw"></i></span>
                                                                                                            <input class="form-control input-lg" placeholder="Localhost" type="text" name="servidor" id="servidor">
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                            <div class="form-group">
                                                                                                    <div class="input-group">
                                                                                                            ...
                                                                                                            <input class="form-control input-lg" placeholder="Usuario" type="text" name="usuario" id="usuario">
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                            <div class="form-group">
                                                                                                    <div class="input-group">
                                                                                                            ...
                                                                                                            <input class="form-control input-lg" placeholder="Contraseña" type="password" name="password" id="password">
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                            <div class="form-group">
                                                                                                    <div class="input-group">
                                                                                                            ...
                                                                                                            <input class="form-control input-lg" disabled="disabled" type="text" name="base" id="base" value="sysecure">
                                                                                                    </div>
                                                                                            </div>
                                                                                    </div>
                                                                            </div>
